    ...
    <div className="min-h-screen bg-white w-screen overflow-x-hidden">
      ...
      <div className="lg:hidden">
        <div className="px-4 py-4 flex items-center">
          <Link to="/pet-preferences" className="text-gray-900">
            <svg
              ...
              <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
                <div className="flex-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors duration-200 resize-none bg-gray-50"
                  />
                </div>
