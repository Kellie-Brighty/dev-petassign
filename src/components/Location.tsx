    ...
    <div className="min-h-screen bg-white dark:bg-[#0A1121] w-screen overflow-x-hidden">
      ...
      <div className="lg:hidden">
        <div className="px-4 py-4 flex items-center justify-between">
          <Link to="/create-bio" className="text-gray-900 dark:text-white">
            <svg
                ...
                <div className="space-y-4 flex-1">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-[#1A2542] focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors duration-200 bg-gray-50 dark:bg-[#1A2542] dark:text-white"
                    />
                  </div>
