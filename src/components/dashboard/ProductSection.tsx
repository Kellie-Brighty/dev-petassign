  ...
  return (
    <div className="mt-5">
      <div className="flex items-center justify-between mb-3 px-4">
        <h2 className="text-base font-medium">Animal Food</h2>
      ...
      <div className="overflow-x-auto hide-scrollbar">
        <div className="flex space-x-3 w-max pb-2 px-4">
          {products.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-lg overflow-hidden shadow-sm w-40 flex-shrink-0"
            >
              ...
              <div className="px-2 pb-2">
                <Link to="/product-details" className="block">
                  <button className="w-full py-1.5 text-center text-xs font-medium bg-primary text-white rounded-md">
                    View
                  </button>
                </Link>
              </div>
