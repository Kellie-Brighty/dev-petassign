    ...
    <div className="min-h-screen bg-gray-100 flex flex-col w-screen">
      ...
      <header className="px-4 py-3 flex items-center justify-between sticky top-0 z-50 bg-white border-b w-screen shadow-sm">
        <div className="flex items-center">
          ...
          <h1 className="text-lg font-medium ml-3">Messages</h1>
        </div>
      ...
      {/* Search Bar */}
      <div className="px-4 py-2 sticky top-[57px] z-40 bg-white border-b w-screen shadow-sm">
        <div className="relative lg:max-w-lg mx-auto">
          <input
            type="text"
            placeholder="Search messages..."
            className="w-full py-2 pl-10 pr-4 rounded-full bg-gray-50 border border-gray-200 focus:outline-none focus:ring-1 focus:ring-primary text-sm"
            value={searchQuery}
        ...
        {filteredChats.length === 0 ? (
          ...
          <div className="lg:max-w-3xl lg:mx-auto">
            {filteredChats.map((chat) => (
              <div
                key={chat.id}
                className="px-4 py-3 flex items-center border-b border-gray-200 hover:bg-gray-50 cursor-pointer bg-white mb-0.5 shadow-sm"
