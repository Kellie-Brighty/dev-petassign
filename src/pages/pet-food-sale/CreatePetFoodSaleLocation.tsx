...
// Mock country options (would typically come from an API)
const countryOptions = ["Nigeria", "Ghana", "Kenya", "South Africa", "Egypt"];

export default function CreatePetFoodSaleLocation() {
  ...
  const handleContinue = () => {
    ...
    navigate("/create-pet-food-sale/contact", {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0A1121] flex flex-col w-screen">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Enter the location where your product is available. This helps buyers
