...
export default function CreatePetFoodSaleDescription() {
  ...
  const handleContinue = () => {
    ...
    navigate("/create-pet-food-sale/price", {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0A1121] flex flex-col w-screen">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Provide detailed information about your pet food product, including
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-24 p-3 bg-gray-100 dark:bg-[#1A2542] rounded-lg border-0 focus:ring-2 focus:ring-primary resize-none dark:text-white"
              placeholder="List the main ingredients in your product"
            />
          </div>
        </form>
      </div>
