...
export default function CreatePetFoodSalePrice() {
  ...
  const handleContinue = () => {
    ...
    navigate("/create-pet-food-sale/location", {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0A1121] flex flex-col w-screen">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Set a competitive price for your pet food product. Consider the
          quantity, quality, and market rates when pricing.
        </p>
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full p-3 pl-8 bg-gray-100 dark:bg-[#1A2542] rounded-lg border-0 focus:ring-2 focus:ring-primary dark:text-white"
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            ...
            <ul className="text-xs text-blue-700 dark:text-blue-400 space-y-1 list-disc pl-4">
              <li>Research similar pet food products to price competitively</li>
              <li>
                Consider your product's size/volume when setting the price
              </li>
              <li>Account for shipping costs if applicable</li>
              <li>
                Be prepared to negotiate slightly within a reasonable range
              </li>
            </ul>
          </div>
        </form>
