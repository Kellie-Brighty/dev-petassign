  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col w-screen">
      ...
      <div className="flex-1 overflow-y-auto pb-28 lg:pb-8 w-full">
        {/* Cover Photo */}
        <div className="relative h-40 lg:h-64 bg-gray-300">
          <img
        ...
        <div className="relative px-4 pt-0 pb-4 lg:max-w-4xl lg:mx-auto">
          ...
          {/* Profile Stats */}
          <div className="grid grid-cols-3 gap-2 bg-white rounded-xl shadow-md p-4 mb-6 border border-gray-200">
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-6">
            {/* My Pets Section */}
            <div className="bg-white rounded-xl shadow-md p-4 mb-6 border border-gray-200 lg:col-span-2">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-md font-semibold text-gray-900">My Pets</h3>
                <button
              ...
              <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
                {userProfile.pets.map((pet) => (
                  <div
                    key={pet.id}
                    className="bg-white rounded-lg p-3 cursor-pointer shadow-sm hover:shadow-md transition-shadow border border-gray-200"
            ...
            {/* Contact Info Section - Added for desktop */}
            <div className="bg-white rounded-xl shadow-md p-4 mb-6 border border-gray-200">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <button className="w-full py-2 text-sm text-center text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors mb-2">
                  Change Password
                </button>
                <button className="w-full py-2 text-sm text-center text-white bg-primary rounded-md hover:bg-primary-dark transition-colors">
