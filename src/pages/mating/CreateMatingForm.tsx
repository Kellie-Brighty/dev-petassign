...
export default function CreateMatingForm() {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0A1121] flex flex-col w-screen">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Enter your pet's details to help potential mates find them. Accurate
          information increases your chances of finding a suitable match.
        </p>
        ...
        <form className="space-y-5">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mt-6">
            ...
            <ul className="text-xs text-blue-700 dark:text-blue-400 space-y-1 list-disc pl-4">
              <li>Ensure your pet is in good health before breeding</li>
              <li>Verify your pet's vaccination status is up to date</li>
              <li>Consider genetic compatibility with potential mates</li>
              <li>
                Be transparent about your pet's health history and temperament
              </li>
            </ul>
          </div>
        </form>
