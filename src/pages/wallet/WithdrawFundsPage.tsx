          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-100 dark:bg-[#1A2542] rounded-md text-gray-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-primary"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-gray-100 dark:bg-[#1A2542] rounded-md text-gray-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-primary pr-10"
                  required
                />
